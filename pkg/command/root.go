...
// Execute is the entry point for the ocis-markdown-editor command.
func Execute() error {
	cfg := config.New()

	app := &cli.App{
		Name:     "ocis-markdown-editor",
		Version:  version.String,
		Usage:    "ocis-markdown-editor",
		...
		Before: func(c *cli.Context) error {
			...
			if c.IsSet("config-file") {
				...
				viper.SetConfigName("markdown-editor")
